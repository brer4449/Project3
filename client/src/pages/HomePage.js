              ...
              <div className="card-body home">
                <div className="carousel">
                  ...
                  <Carousel indicators={false}>
                    ...
                    <Carousel.Item>
                      <img
                        src={process.env.PUBLIC_URL + "/images/pic6.jpg"}
                        height="200px"
                        alt="pic6"
                        width="500px"
                      />
                    ...
                    <Carousel.Item>
                      <img
                        src={process.env.PUBLIC_URL + "/images/pic8.jpg"}
                        height="200px"
                        alt="pic8"
                        width="500px"
                      />
                    ...
                    <Carousel.Item>
                      <img
                        src={process.env.PUBLIC_URL + "/images/pic7.jpg"}
                        height="200px"
                        alt="pic7"
                        width="500px"
                      />
                ...
                <h4 className="text">
                  BidBot is an auction site, selling items from jewelry to home
                  appliances for unbeatable prices! Discover our best deals and
                  start saving now!
                </h4>
              </div>
